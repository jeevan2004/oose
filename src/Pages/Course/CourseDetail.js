                ...
                <div class="courses__details-content">
                  <ul class="courses__item-meta list-wrap">
                    ...
                    <li class="avg-rating">
                      ...
                      {detailData?.rating} Reviews
                    </li>
                  </ul>
                  <h2 class="title">{detailData?.courseName}</h2>
                    ...
                    <ul class="list-wrap">
                      <li class="author-two">
                        ...
                        <a href="https://skillgro.websolutionus.com/instructor-details/1002">
                          {detailData?.instructorId[0]?.role.name}
                        </a>
                      </li>
                      <li class="date">
                  ...
                  <div class="tab-content" id="myTabContent">
                    ...
                    >
                      <div class="courses__curriculum-wrap">
                        ...
                        <div class="accordion" id="accordionExample">
                          {detailData?.curriculum.map((item) => {
                            return (
                              <>
                    ...
                    <div
                      ...
                      tabindex="0"
                    >
                      {detailData?.instructorId.map((item) => {
                        return (
                          <>
                            <div class="courses__instructors-wrap">
                              ...
                              <div class="courses__instructors-content">
                                ...
                                <p>
                                  I am a web developer with a vast array of
                                  knowledge in many different front end and back
                                  end languages, responsive frameworks,
            ...
            <div className="col-md-4">
              <div class="courses__details-sidebar">
                <div class="courses__cost-wrap">
                  ...
                  <h2 class="title">{detailData?.price}</h2>
                </div>
                <div class="courses__information-wrap">
                  ...
                  <ul class="list-wrap">
                    ...
                    <li>
                      ...
                      Certifications
                      <span>{detailData?.certifications}</span>
                    </li>
                    <li class="level-wrapper">
                      <b>
                        <svg
                      ...
                      <ul class="course-language-list">
                        <span>{detailData?.languageId?.name}</span>
                      </ul>
                    </li>
                  </ul>
                </div>
